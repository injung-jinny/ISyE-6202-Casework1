...
# Y-A trend: current market (Year 0) through Year 5, assuming the case base growth
...
(OUT/'summary.json').write_text(json.dumps(summary,indent=2),encoding='utf-8')
print(json.dumps(summary,indent=2))
+f'{val/1_000_000_000:.2f}B',(yr,val),textcoords='offset points',xytext=(0,-15),ha='center',fontsize=8)
